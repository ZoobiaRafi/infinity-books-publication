...
/**
 * One-time migration of the original 3 hardcoded blog posts (formerly
 * inline in FrontendController::blogPosts()) into the blog_posts table.
...
class BlogPostsTableSeeder extends Seeder
{
    ...
    private function data(): array
    {
        return [
            [
                'slug' => 'choosing-the-right-ghostwriter',
